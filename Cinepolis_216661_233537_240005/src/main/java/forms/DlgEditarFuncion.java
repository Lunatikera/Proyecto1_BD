 ...
 * @author Usuario
 */
public class DlgEditarFuncion extends javax.swing.JDialog {
    ...
    public DlgEditarFuncion(java.awt.Frame parent, boolean modal, ISalaNegocio salaNeg, IFuncionNegocio funcionNeg, ISucursalNegocio sucursalNeg,
            SucursalDTO sucursal, PeliculaDTO pelicula, FuncionDTO funcion, SalaDTO sala) {
        super(parent, modal);
        initComponents();
    ...
    private void llenarCampos() {
        cbDia.setSelectedItem(funcionDTO.getDia());
        cbSala2.setSelectedItem(sala);
    }
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        if (modoEstreno) {
            try {
                ...
                FuncionDTO funcion = new FuncionDTO(funcionDTO.getId(), dia, medianoche, sala.getId(), pelicula.getId());
                funcionNeg.editarFuncion(funcion);
                peliculaFuncion.cargarFuncionesEnTabla();
                JOptionPane.showMessageDialog(this, "Funcion editada exitosamente!", "Éxito", JOptionPane.INFORMATION_MESSAGE);
                dispose();
            } catch (NegocioException ex) {
                JOptionPane.showMessageDialog(this, "No se pudo editar la pelicula: Verifica las demas funciones ", "Error al editar la pelicula", JOptionPane.ERROR_MESSAGE);
        ...
        if (!modoEstreno) {
            ...
            try {
                ...
                FuncionDTO funcion = new FuncionDTO(funcionDTO.getId(), dia, hora, sala.getId(), pelicula.getId());
                System.out.println("0" + funcion);
                funcionNeg.editarFuncion(funcion);
                peliculaFuncion.cargarFuncionesEnTabla();
                JOptionPane.showMessageDialog(this, "Funcion editada exitosamente!", "Éxito", JOptionPane.INFORMATION_MESSAGE);
                dispose();
